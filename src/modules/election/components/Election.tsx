...
export const Election = ({subElections, selectedCandidates, onCandidateClick, onSubmit}: ElectionProps) => (
    <Grid container alignItems={"center"} direction={"column"}>
        <div className={styles.root}>
            <Typography variant={"h3"} align={"center"} className={styles.header}>{"Kandidaten wählen:"}</Typography>
